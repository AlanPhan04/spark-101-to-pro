...
% running example (App. A, the orders table + star schema) threads through
% every chapter. How to run the examples against your own cluster, and what to
% do if your stack differs from the reference environment.
